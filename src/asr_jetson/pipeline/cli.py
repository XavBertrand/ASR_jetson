...
def main():
    ...
    p.add_argument("--whisper-model", default="medium", help="Whisper size (tiny/base/small/...)")
    p.add_argument("--whisper-compute", default="int8", help="CTranslate2 compute_type")
    p.add_argument("--lang", default=None, help="Force language code (e.g. fr, en)")
